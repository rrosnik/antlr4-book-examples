...
import RowsVisitor from "./RowsVisitor.js";
		...
		try {
			...
			do {
				...
				localctx._STUFF = this.match(RowsParser.STUFF);
				        ...
				        localctx.i++;
				        if(this.col === localctx.i) {
				            console.log(`${(localctx._STUFF != null ? localctx._STUFF.text : undefined)}`);
				        }
...
export class FileContext extends ParserRuleContext {
	...
	// @Override
	public accept<Result>(visitor: RowsVisitor<Result>): Result {
